...
<!--chapter:end:02-CommunityBasedResearch.Rmd-->
...
<!--chapter:end:03-OpenScience.Rmd-->
...
* Proposed assignments (beyond those imbedded in the chapter)
* Grading rubrics for research-related assigments
* Lists of additional resources

# References

<!--chapter:end:05-PlannedChapters.Rmd-->
